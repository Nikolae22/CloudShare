...
public class ClerkJwksProvider {
    ...
    private static final long CACHE_TTL = 3600000; //1hour


    public PublicKey getPublicKey(String keyId) throws IOException, NoSuchAlgorithmException, InvalidKeySpecException {
    ...
    private PublicKey createPublicKey(String modulus, String exponent) throws NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        byte[] modulesByte = Base64.getUrlDecoder().decode(modulus);
        byte[] exponentByte = Base64.getUrlDecoder().decode(exponent);

        BigInteger modulusBigInt = new BigInteger(1, modulesByte);
