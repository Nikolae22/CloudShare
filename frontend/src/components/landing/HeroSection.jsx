                    ...
                    <div className='text-center'>
                        ...
                        <div className='mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center'>
                            <div
                                ...
                                <button
                                    onClick={()=>openSignIn()}
                                    className='flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10 transition-all duration-200 shadow-md hover:shadow-xl'>Sign In</button>
