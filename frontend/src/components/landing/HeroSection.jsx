...
export default function HeroSection() {
    ...
    return (
        <div className='landing-page-content relative'>
            <div className='absolute inset-0 bg-gradient-to-r from-purple-50 opacity-80 z-0 pointer-events-none'>
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
                <div className='pt-20 pb-16 sm: pt-24 sm:pb-20 lg:pt-32 lg:pb-28'>
                    <div className='text-center'>
                        ...
                        <div className='mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center'>
                            <div
                                className='space-y-4 sm:space-y-0 sm:max-auto sm:inline-grid sm:grid-cols-2 sm:gap-5'>
                                ...
                                <button className='flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10 transition-all duration-200 shadow-md hover:shadow-xl'>Sign In</button>
                ...
                <div className='relative'>
                    <div className='aspect-w-16 rounded-lg shadow-xl overflow-hidden'>
                        <img src={assets.dashboard} alt="Dashboard" className='w-full h-full object-cover'/>
                    </div>
